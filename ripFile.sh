...
AUDIO_CHANNEL_FIX=${AUDIO_CHANNEL_FIX:-1}
...
AUDIO_LAYOUT_ARGS="-filter:a channelmap=channel_layout=${AUDIO_CHANNEL_LAYOUT} -c:a ${AUDIO_FORMAT} -q:a ${AUDIO_QUALITY} -map 0:${AUDIO_TRACK}"
