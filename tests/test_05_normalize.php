...
test("Stream 1", "audio", $probe["streams"][2]["codec_type"]);
test("Stream 1 codec", "aac", $probe["streams"][2]["codec_name"]);
test("Stream 1 channel_layout", "5.1", $probe["streams"][2]["channel_layout"]);
test("Stream 1 channels", 6, $probe["streams"][2]["channels"]);
test("Stream 1 title", "Normalized  5.1", $probe["streams"][2]["tags"]["title"]);
